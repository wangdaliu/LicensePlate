...
public class HomeFragment extends BaseFragment implements TabHost.OnTabChangeListener, TabHost.TabContentFactory, ViewPager.OnPageChangeListener {
    ...
    public void onTabChanged(String tabId) {
        ...
        for (int i = 0; i < mTabHost.getTabWidget().getChildCount(); i++) {
            ...
            if (page == i) {
                ...
                ((TextView) (tabView.findViewById(R.id.title))).setTextColor(getResources().getColor(android.R.color.white));
            } else {
                tabView.findViewById(R.id.directory_line).setVisibility(View.GONE);
                ((TextView) (tabView.findViewById(R.id.title))).setTextColor(getResources().getColor(R.color.tab_unfocus));
            }
        }
    }
